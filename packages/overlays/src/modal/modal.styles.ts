  ...
  "fixed z-50 bg-base-100 rounded-xl shadow-xl border border-base-200 focus:outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 max-h-[85vh] overflow-y-auto",
  {
    variants: {
      ...
      placement: {
        ...
        top:    "left-1/2 top-[5vh] -translate-x-1/2 sm:left-1/2 sm:top-[10vh] sm:-translate-x-1/2",
      },
    },
...
export const modalStyles = {
  ...
  header:  "flex items-center justify-between px-4 pt-4 pb-2 sm:px-6 sm:pt-6 sm:pb-2",
  body:    "px-4 py-3 sm:px-6 sm:py-4",
  footer:  "flex items-center justify-end gap-2 px-4 pt-2 pb-4 sm:px-6 sm:pt-2 sm:pb-6",
  close:   "absolute top-2 right-2 sm:top-3 sm:right-3 inline-flex items-center justify-center rounded-md p-1.5 text-base-content/70 hover:text-base-content hover:bg-base-200 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
};
