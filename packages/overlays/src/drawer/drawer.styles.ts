...
export const DRAWER_PLACEMENT: Record<DrawerPlacement, string> = {
...
export const DRAWER_SIZES_HORIZONTAL: Record<DrawerSize, string> = {
  xs: 'w-64',
  sm: 'w-80',
  md: 'w-96',
  lg: 'w-[32rem]',
...
export const DRAWER_SIZES_VERTICAL: Record<DrawerSize, string> = {
  xs: 'h-48',
  sm: 'h-64',
  md: 'h-80',
  lg: 'h-96',
