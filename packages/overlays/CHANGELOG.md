...
- [#72](https://github.com/ninna-ui/ninna-ui/pull/72) [`be3640e`](https://github.com/ninna-ui/ninna-ui/commit/be3640e160fea66ff4d797ccc61d19c7a51f40e8) Thanks [@chnkc41](https://github.com/chnkc41)! - Expose `Popover.Content`'s `onOpenAutoFocus` callback so consumers can prevent focus from moving into the popover when it opens.
