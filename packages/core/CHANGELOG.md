...
- [#59](https://github.com/ninna-ui/ninna-ui/pull/59) [`34af89e`](https://github.com/ninna-ui/ninna-ui/commit/34af89ee25c996ee15c47306f6b6b1a574b4fdb2) Thanks [@chnkc41](https://github.com/chnkc41)! - **Build:** Extracted the inline `node -e` CSS-copy one-liner from the `build` script into a dedicated `scripts/copy-css.mjs` ESM module. Build output is unchanged — `dist/theme/` contains the same CSS files as before.
