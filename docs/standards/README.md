...
- **[TESTING_STRATEGY.md](./TESTING_STRATEGY.md)** - Testing strategy: 700+ tests, @sa11y/vitest accessibility audits, priority-based coverage matrix, co-located test files
