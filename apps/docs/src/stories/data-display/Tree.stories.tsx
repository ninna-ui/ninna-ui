...
const fileTree: TreeNode[] = [
    ...
    children: [
      {
        id: "favicon",
        label: "favicon.ico",
        icon: <ImageIcon size={14} className="text-yellow-400" />,
      },
      {
        id: "index-html",
        label: "index.html",
  ...
  },
  {
    id: "tsconfig",
    label: "tsconfig.json",
    icon: <FileJson size={14} className="text-white/40" />,
  },
];
    ...
    const explorerData: TreeNode[] = [
      {
        ...
        children: [
          ...
          { id: "gitignore", label: ".gitignore", icon: <Globe size={14} /> },
                ...
                children: [
                  {
                    id: "1-1-1-1",
                    label: "Level 4",
                    children: [{ id: "1-1-1-1-1", label: "Level 5 - Leaf" }],
                  },
                ],
              },
            ],
